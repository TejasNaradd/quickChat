    ...
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-scroll ${selectedUser ? 'max-md:hidden' : ''}`}>
      ...
      <div>
        <button onClick={()=>logout()}
         className='absolute bottom-5 left-1/2 -translate-x-1/2 bg-gradient-to-r from-purple-400 to-violet-600 text-white border-none text-sm font-light px-20 py-2 rounded-full cursor-pointer'>
          Logout
        </button>
      </div>
    </div>
